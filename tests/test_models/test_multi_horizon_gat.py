...
class TestMultiHorizonGraphBuilder:
    ...
    def test_multi_horizon_targets_match_single(self, sample_flight_df, airport_map):
        ...
        # Single horizon
        next_mask = (df["timestamp"] >= current_end) & (
    ...
    def test_create_temporal_graphs_single_horizon(self, sample_flight_df, airport_map):
        """Without prediction_horizons, targets are [num_nodes] (legacy)."""
    ...
    def test_create_temporal_graphs_multi_horizon(self, sample_flight_df, airport_map):
    ...
    def test_single_horizon_list_backward_compat(self, sample_flight_df, airport_map):
